	...
	<div class="bg-text">
		<div class="row">
			...
			<div class="right" style="background-color: #ddd;">
				<h1>Tag Manager</h1>
				<div>
					<a href="addTagForm" class="btn btn-success float-left">Add Tag</a>
				</div>
				<table border="1" class="table table-striped table-responsive-md">
					...
					<tr>
						<c:forEach items="${data}" var="tagdetails">
							<tr>
								<td>${tagdetails.id}</td>
								<td>${tagdetails.tag}</td>
								<td>
									<a href="/updateTagForm/${tagdetails.id}" class="btn btn-info">Update</a>
									<a href="/deleteTag/${tagdetails.id}" class="btn btn-danger ml-2">Delete</a>
								</td>
							</tr>
						</c:forEach>
					</tr>
